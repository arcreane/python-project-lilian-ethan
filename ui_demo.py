...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton.setGeometry(QRect(30, 40, 79, 31))
        self.planeLabel = QLabel(self.centralwidget)
        self.planeLabel.setObjectName(u"planeLabel")
        self.planeLabel.setGeometry(QRect(160, 20, 121, 91))
        ...
        self.radarView.setGeometry(QRect(-15, -29, 911, 711))
        ...
        self.pushButton.clicked.connect(MainWindow.demo)
